...
public class NotificationHeaderViewWrapper extends NotificationViewWrapper {
    ...
    protected NotificationHeaderViewWrapper(Context ctx, View view, View row) {
        super(ctx, view, row);
        mInvertHelper = new ViewInvertHelper(ctx, 700 /*NotificationPanelView.DOZE_ANIMATION_DURATION*/);
    ...
    protected void resolveHeaderViews() {
        ...
        //mWorkProfileImage = mView.findViewById(R.id.profile_badge);
        mColor = resolveColor(mExpandButton);
        mNotificationHeader = mView.findViewById(R.id.notification_header);
    ...
    private int resolveColor(ImageView icon) {
        if (icon != null && icon.getDrawable() != null) {
            ...
            if (filter instanceof PorterDuffColorFilter) {
                return (int) XposedHelpers.callMethod(filter, "getColor");
            }
        }
        return 0;
    }
    ...
    public void onContentUpdated(View row) {
        ...
        mIsLowPriority = false /*row.isLowPriority()*/; //TODO implement
        mTransformLowPriorityTitle = false /*!row.isChildInGroup() && !row.isSummaryWithChildren()*/; //TODO implement
