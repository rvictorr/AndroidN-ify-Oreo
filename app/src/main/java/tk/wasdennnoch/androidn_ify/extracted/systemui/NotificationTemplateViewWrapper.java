...
public class NotificationTemplateViewWrapper extends NotificationHeaderViewWrapper {
    ...
    private void resolveTemplateViews(StatusBarNotification notification) {
        mPicture = mView.findViewById(mView.getContext().getResources().getIdentifier("right_icon", "id", PACKAGE_ANDROID));
        if (mPicture != null) {
            mPicture.setTag(ImageTransformState.ICON_TAG,
                    notification.getNotification().getLargeIcon());
        }
        mTitle = mView.findViewById(mView.getContext().getResources().getIdentifier("title", "id", PACKAGE_ANDROID));
        mText = mView.findViewById(mView.getContext().getResources().getIdentifier("text", "id", PACKAGE_ANDROID));
        final View progress = mView.findViewById(mView.getContext().getResources().getIdentifier("progress", "id", PACKAGE_ANDROID));
        ...
        mActionsContainer = mView.findViewById(R.id.actions_container);
    }
    ...
    public void onContentUpdated(View row) {
        ...
        resolveTemplateViews((StatusBarNotification) ReflectionUtils.invoke(Methods.SystemUI.ExpandableNotificationRow.getStatusBarNotification, row));
    ...
    protected void updateInvertHelper() {
        ...
        View mainColumn = mView.findViewById(mView.getContext().getResources().getIdentifier("notification_main_column", "id", PACKAGE_ANDROID));
        if (mainColumn != null) {
