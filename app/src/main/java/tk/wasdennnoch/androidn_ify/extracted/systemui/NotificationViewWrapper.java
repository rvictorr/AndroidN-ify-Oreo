...
public abstract class NotificationViewWrapper implements TransformableView {
    ...
    public static NotificationViewWrapper wrap(Context ctx, View v, View row) {
        if (v.getId() == ctx.getResources().getIdentifier("status_bar_latest_event_content", "id", PACKAGE_ANDROID)) {
            ...
            } else if ("media".equals(v.getTag()) || "bigMediaNarrow".equals(v.getTag()) || "bigMedia".equals(v.getTag())) {
    ...
    protected NotificationViewWrapper(Context ctx, View view, View row) {
        mView = view;
        mRow = row;
